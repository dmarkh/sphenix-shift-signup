...
function confirm_changes(str, ids) {
    var params = '&par_I='+document.getElementById('par_I').value + '&par_T='+document.getElementById('par_T').value + '&par_P='+document.getElementById('par_P').value + '&par_M='+document.getElementById('par_M').value;
    var go = confirm(str);
    if (go) {
...
<input type="hidden" name="do" value="rejectiontest">
</fieldset>
</form>
</p>
<?php } ?>
...
<TD align="center"><?php echo intval($v['pct_miss']).'%'; ?></TD>
<!--
